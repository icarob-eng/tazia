...
fig.savefig(f'results/{enconder}.pca-kmeans.png')
...
Methodology: k-means grouping with PCA reduction for {enconder}.
...
print(result)
with open(f'results/{enconder}.pca-kmeans.report.txt', 'w+') as f:
    f.write(result)
